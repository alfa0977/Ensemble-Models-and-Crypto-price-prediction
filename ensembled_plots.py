...
plt.rcParams["axes.edgecolor"] = "0.15"  # Set axes edge color
plt.rcParams["axes.linewidth"] = 1.25  # Set axes line width
...
with tab1:
    with st.expander(label="baggin circle",expanded=True):
        st.pyplot(plot_bagging())  # Plot bagging diagram
with tab2:
    with st.expander(label="boosting circle",expanded=True):
        st.pyplot(plot_boosting())  # Plot boosting diagram

import numpy as np  # Import numpy again (redundant)
import matplotlib.pyplot as plt  # Import matplotlib again (redundant)
import seaborn as sns  # Import seaborn again (redundant)
import networkx as nx  # Import networkx again (redundant)
